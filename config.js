...
const API_BASE_REPORT_DATAMART = '/ms-report-datamart/';
...
export {
    API_BASE, API_BASE_NOTIFICATION, API_BASE_ACCOUNTING, API_BASE_INVENTORY, colors, actionTimer, roleWarehouse, amqpVHost, tDisplayOpt,
